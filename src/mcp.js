...
export async function invokeTool(client, name, input = {}) {
  switch (name) {
    ...
    case "xbow_get_meta_addresses":
      return jsonContent(await client.request("/meta/addresses"));
    case "xbow_get_meta_openapi":
      return jsonContent(await client.request("/meta/openapi.json"));
    case "xbow_get_meta_webhook_signing_keys":
      return jsonContent(await client.request("/meta/webhooks-signing-keys"));
    ...
    case "xbow_get_asset": {
      ...
      return jsonContent(await client.request(`/assets/${assetId}`));
    }
    ...
    case "xbow_get_assessment": {
      ...
      return jsonContent(await client.request(`/assessments/${assessmentId}`));
    }
    ...
    case "xbow_get_report": {
      ...
      return jsonContent(await client.request(`/reports/${reportId}`));
    }
    case "xbow_get_report_summary": {
      const reportId = ensureString(input.reportId, "reportId");
      return jsonContent(await client.request(`/reports/${reportId}/summary`));
    }
